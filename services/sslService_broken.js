    ...
    try {
      ...
      return new Promise((resolve, reject) => {
        ...
        socket.on('error', (error) => {
          ...
          // Don't immediately mark as no SSL - try file check first
          resolve({ connectionFailed: true, domain, error: error.message });
        });
        ...
        socket.on('timeout', () => {
          ...
          resolve({ connectionFailed: true, domain, error: 'Connection timeout' });
        });
      });
